...
public class RayInteraction2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Physics.Raycast(transform.position + new Vector3(0, 1, 0), transform.forward, out hit, distance))
        {
            ...
            if (hit.collider.tag == "npc3")
            {
                ...
                NPC_List[2].transform.LookAt(this.transform);

                //npcbool2 = true;
                NPCinteraction_List[2].SetActive(true);
        ...
        if (Physics.Raycast(transform.position + new Vector3(0, 1, 0), transform.forward, out hit, distance))
        {
            ...
            if (hit.collider.tag == "npc4")
            {
                ...
                NPC_List[3].transform.LookAt(this.transform);

                //npcbool2 = true;
                NPCinteraction_List[3].SetActive(true);
        ...
        if (Physics.Raycast(transform.position + new Vector3(0, 1, 0), transform.forward, out hit, distance))
        {
            ...
            if (hit.collider.tag == "npc5")
            {
                ...
                NPC_List[4].transform.LookAt(this.transform);

                //npcbool2 = true;
                NPCinteraction_List[4].SetActive(true);
