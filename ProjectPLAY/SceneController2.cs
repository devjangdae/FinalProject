    ...
    public class SceneController2 : MonoBehaviour
    {
        public static SceneController2 Instance
        {
            get
            {
                ...
                instance = FindObjectOfType<SceneController2>();
        ...
        protected static SceneController2 instance;

        public static SceneController2 Create()
        {
            GameObject sceneControllerGameObject = new GameObject("SceneController2");
            instance = sceneControllerGameObject.AddComponent<SceneController2>();
